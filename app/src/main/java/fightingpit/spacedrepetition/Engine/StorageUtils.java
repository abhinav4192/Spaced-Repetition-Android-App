...
public class StorageUtils {
    ...
    {
        return ((GlobalApplication) ContextManager.getCurrentActivityContext().getApplicationContext())
                .getDatabaseMethods();
    }
    ...
    public static boolean addRepetitionPattern(String iName, ArrayList<Integer> iRepetitionSpaces){
        ...
        aReturnValue = aDatabaseMethods.addRepetitionPattern(new RepetitionPattern(aPatternId,iName,
    ...
    public static boolean addTask(String iName, String iComment, String iPatternId){
        ...
        for(RepetitionPatternSpace aRepetitionPatternSpace: aDatabaseMethods.getRepetitionPatternSpace(iPatternId))
        {
